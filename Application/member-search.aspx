<%@ Page Title="" Language="C#" MasterPageFile="~/UMS.Master" AutoEventWireup="true" CodeBehind="member-search.aspx.cs" Inherits="Template.manage_members" %>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6" id="divSearch" runat="server" visible="false">
                                            <div class="dataTables_filter">
                                                <asp:LinkButton ID="lbAdd" runat="server" CssClass="btn btn-sm btn-primary" OnClick="lbAdd_Click"><i class="fa fa-plus-circle mr-2"></i>Add Member</asp:LinkButton>
                                                <asp:TextBox ID="txtDescription" runat="server" CssClass="form-control form-control-sm" placeholder="Search Name" autocomplete="off"></asp:TextBox>
                                            ...
                                            <asp:GridView ID="gvMaintenance" runat="server" AllowPaging="True" CssClass="table table-bordered table-striped dataTable dtr-inline"
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lbView" runat="server" CommandArgument='<%# Eval("Member ID")%>' ToolTip="View"
                                                                Text="" OnClick="lbView_Click" class="mr-2"><i class="fa fa-eye text-dark" style="text-decoration:none"></i></asp:LinkButton>
                                                            <asp:LinkButton ID="lbEdit" runat="server" CommandArgument='<%# Eval("Member ID")%>' ToolTip="Edit"
