                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item"><a href="#">Ministry Department Maintenance</a></li>
                            <li class="breadcrumb-item active">Add Ministry Department </li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card card-primary" id="cardMaintenance" runat="server">
                        <div class="card-header">
                            <h3 class="card-title">Ministry Department</h3>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <asp:LinkButton ID="btnSubmit" runat="server" CssClass="btn btn-success float-right" OnClick="btnSubmit_Click"
                        OnClientClick="if(Page_ClientValidate('codeDescValidation')) { if(this.value === 'Please wait...') { return false; } else { this.value = 'Please wait...'; }}" CausesValidation="true" ValidationGroup="memberValidation">Add Ministry Department</asp:LinkButton>
                </div>
            </div>
        </section>
        <!-- /.content -->
