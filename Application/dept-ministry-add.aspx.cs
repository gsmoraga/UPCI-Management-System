...
namespace Template
{
    public partial class ministry_dept_add : System.Web.UI.Page
    {
        BLL _BLL = new BLL();
        DAL _DAL = new DAL();
            ...
            if (_BLL.SessionIsActive(this))
            {
                ...
                if (Convert.ToInt32(dt.Rows[0][0]) == 0)
                {
                    ...
                    else
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, GetType(), "Script", "transactionAlert('Ministry Department has been added.','" + transactionReferenceNumber + "');", true);
