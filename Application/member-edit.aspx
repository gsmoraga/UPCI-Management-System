<%@ Page Title="" Language="C#" MasterPageFile="~/UMS.Master" AutoEventWireup="true" CodeBehind="member-edit.aspx.cs" Inherits="Template.member_edit" %>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtEmail" CssClass="form-control" runat="server" MaxLength="50" autocomplete="off" placeholder="Optional"></asp:TextBox>
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtMobileNumber" CssClass="form-control" MaxLength="50" runat="server" autocomplete="off" placeholder="Optional"></asp:TextBox>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <asp:LinkButton ID="btnSave" runat="server" CssClass="btn btn-success float-right"
                        OnClientClick="if(Page_ClientValidate('memberValidation')) { if(this.value === 'Please wait...') { return false; } else { this.value = 'Please wait...'; }}" CausesValidation="true" ValidationGroup="memberValidation" OnClick="btnSave_Click">Save Changes</asp:LinkButton>
                </div>
            </div>
        </section>
    </div>
