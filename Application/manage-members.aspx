<%@ Page Title="" Language="C#" MasterPageFile="~/UPCI.Master" AutoEventWireup="true" CodeBehind="manage-members.aspx.cs" Inherits="Template.manage_members" %>
    ...
    <div ondragstart="return false" draggable="false">
                    ...
                    <div class="col-md-10 text-md-left card-body">
                        <div id="divSearch" runat="server" visible="true">
                            <div class="form-group row align-items-center">
                                <label for="txtCode" class="col-md-4 col-form-label text-md-right" id="lblTransRefNumber" runat="server">Member ID</label>
                                <div class="col-md-4">
                                    <asp:TextBox runat="server" ID="txtMemberId" MaxLength="50" autocomplete="off" class="form-control"></asp:TextBox>
                                </div>
                                <div class="col-md-4">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="searchValidation"
                                        ErrorMessage="Must be alphanumeric." ControlToValidate="txtMemberId" ValidationExpression="^[a-zA-Z0-9\s]*$"
                            ...
                            <div class="form-group row align-items-center" id="divDescription" runat="server">
                                <label for="txtDescription" class="col-md-4 col-form-label text-md-right" id="lblControlNo"
                                    ...
                                    Name</label>
                                <div class="col-md-4">
                                    <asp:TextBox runat="server" ID="txtName" autocomplete="off" class="form-control"></asp:TextBox>
                                </div>
                                <div class="col-md-4">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center" id="div2" runat="server">
                                ...
                                <div class="col-md-4">
                                    <asp:DropDownList ID="ddMembershipStatus" runat="server" CssClass="form-select"></asp:DropDownList>
                                </div>
                            </div>
        ...
        <div class="row justify-content-center m-1">
            <div class="col-md-10 text-md-center table-responsive">
                <asp:GridView ID="gvApplication" runat="server" AllowPaging="True" CssClass="table table-striped"
                    ...
                    <HeaderStyle BackColor="#DEE2E6" Font-Bold="True" ForeColor="Black" HorizontalAlign="Left" />
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                                <asp:LinkButton ID="lbView" runat="server" CommandArgument='<%# Eval("Member ID") %>'
                                ...
                                <asp:LinkButton ID="lbEdit" runat="server" CommandArgument='<%# Eval("Member ID") %>'
                                    ToolTip="Edit" Text="" OnClick="lbEdit_Click"><i class="bi bi-pencil-square text-primary" style="text-decoration:none"></i></asp:LinkButton>
